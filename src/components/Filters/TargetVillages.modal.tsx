...
const TargetVillagesModal = (
    ...
    const handleSave = () => {
        ...
        context.filter.targetVillages[1](coords.map((coord) => context.data.village[0].filter((village) => `${village.x}|${village.y}` == coord)[0]).filter((x) => typeof x != 'undefined'))
        handleClose()
    }
    ...
    return (
        <Modal show={props.isVisible} onHide={handleClose}>
            <Modal.Header closeButton>
                <Modal.Title>Cele akcji</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Container>
                ...
                <Container>
                    ...
                    <OverlayTrigger
                        ...
                        overlay={
                            <Popover>
                                <ColorPicker color={context.filter.targetVillagesColor[0]} onChange={(e) => context.filter.targetVillagesColor[1](e.hex)} />
                            </Popover>
                        }
                    >
                        <ColorPickerWrapper style={{ backgroundColor: context.filter.targetVillagesColor[0] }} />
                    </OverlayTrigger>
                </Container>
            </Modal.Body>
            <Modal.Footer>
...
export default TargetVillagesModal
